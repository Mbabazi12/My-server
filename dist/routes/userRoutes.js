...
router.post('/create', datachecker_1.dataChecker.inputIsEmpty, datachecker_1.dataChecker.EmailExist, userControllers_1.default.createUser);
...
router.delete('/delete', userControllers_1.default.deleteAllUser);
